...
export function normalizeCinematicSettings(raw) {
  ...
  return {
    ...
    cameraZoom: clamp(Number(raw.cameraZoom) ?? d.cameraZoom, 0, 100),
...
export const CINEMATIC_SLIDERS = [
  ...
  { key: 'vignette', label: 'Vignette (dark edge fade)', min: 0, max: 100 },
  ...
  { key: 'letterbox', label: 'Letterbox (top/bottom bars)', min: 0, max: 100 },
